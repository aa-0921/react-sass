...
var Button = function Button(_ref) {
  ...
  return /*#__PURE__*/React.createElement("button", _extends({
    ...
    className: _JSXStyle.dynamic([["2745287397", [padding, height, height, minWidth, width, theme.layout.radius, fontSize, color, bg, border, cursor, events, shadow ? theme.expressiveness.shadowSmall : 'none', padding, height, color, hover.color, hover.color, hover.bg, hover.border, cursor, events, shadow ? theme.expressiveness.shadowMedium : 'none', shadow ? '-1px' : '0px']]]) + " " + (props && props.className != null && props.className || "btn ".concat(className))
  }), loading ? /*#__PURE__*/React.createElement(ButtonLoading, null) : childrenWithIcon, dripShow && /*#__PURE__*/React.createElement(ButtonDrip, {
    x: dripX,
    y: dripY,
    color: dripColor,
...
var MemoButton = React.memo(Button);
